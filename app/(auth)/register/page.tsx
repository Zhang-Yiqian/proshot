      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-black p-8 shadow-[12px_12px_0px_0px_#000]">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-serif font-bold italic tracking-tight">Join the Studio</h1>
          ...
          <div className="mt-8 text-center text-xs uppercase tracking-widest text-gray-500 border-t border-gray-100 pt-6">
            Already a member?{' '}
            <Link href="/login" className="text-black font-bold border-b border-black hover:opacity-70 ml-1">
              Log In
            </Link>
          </div>
        </div>
